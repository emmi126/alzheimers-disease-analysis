...
new = True
if os.path.exists('../../output/assemblies_post_template_50.pkl') and new == False:
    assemblies = pickle.load(open('../../output/assemblies_post_template_50.pkl', 'rb'))
else:
    for strain in files:
    ...
    pickle.dump(assemblies, open('../../output/assemblies_post_template_50.pkl', 'wb'))