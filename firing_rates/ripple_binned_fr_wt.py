...
g2.set_ylabel("INT")
g2.set_xlabel("Time relative to ripple onset (ms)")
...
plt.show()
# plt.savefig('../output/firing_dynamics/ripple_binned_fr_wt.png', dpi=300)
plt.savefig(os.path.join('/Users/emilyz/Documents', 'ripple_binned_fr_wt.png'), dpi=300)
...
plt.savefig('../output/firing_dynamics/ripple_binned_fr_wt_notext.png', dpi=300)"""