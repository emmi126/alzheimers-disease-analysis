...
# subs = ['18-1', '25-10', '36-3', '36-1', '64-30', '59-2', '62-1']
subs = ['64-30', '59-2', '62-1']
...
for sub in subs:
    ...
    end_time = np.amin(ts_all) + 30 * 60 * 1000000
    ...
    end_time = np.amin(ts2_all) + 30 * 60 * 1000000
